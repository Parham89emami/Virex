...
class User(Base):
    ...
    configs: Mapped[list["VPNConfig"]] = relationship(back_populates="sold_to_user")
...
class Order(Base):
    ...
    config: Mapped["VPNConfig | None"] = relationship(foreign_keys=[config_id])
...
class VPNConfig(Base):
    ...
    sold_to_user: Mapped[User | None] = relationship(back_populates="configs")
