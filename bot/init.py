...
from bot.handlers.orders import confirm_plan, my_orders, select_plan, show_plans
from bot.handlers.payments import handle_receipt
from bot.handlers.start import about_command, main_menu_router, orders_command, start, support_command
...
def register_handlers(application: Application) -> None:
    ...
    application.add_handler(CallbackQueryHandler(start, pattern=r"^menu:main$"))
    application.add_handler(CallbackQueryHandler(show_plans, pattern=r"^menu:plans$"))
