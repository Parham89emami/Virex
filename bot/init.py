...
from bot.handlers.admin import add_config, add_product, admin_panel, broadcast, confirm_order, configs, create_coupon, delete_config, delete_product, edit_product, products, reject_order, set_block, toggle_product, user_action, wallet_adjust
...
def register_handlers(application: Application) -> None:
    commands = {
        ...
        "users": user_action, "block": set_block, "unblock": set_block, "coupon": create_coupon,
