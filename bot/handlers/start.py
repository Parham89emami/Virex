...
async def main_menu_router(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    if text in {"🛒 خرید VPN", "خرید VPN", "📦 محصولات"}:
